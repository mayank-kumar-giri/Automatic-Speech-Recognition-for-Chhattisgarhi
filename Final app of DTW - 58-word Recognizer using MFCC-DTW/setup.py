...
cx_Freeze.setup(
    ...
    options = {"build_exe":{"packages":["tkinter", "speech_recognition", "threading", "time", "matplotlib", "numpy", "librosa", "copy", "sklearn", "winsound", "scipy", "os"], "include_files":["audio.ico","icon.ico", "wait.ico", "mic.ico", "save.ico", "Training_label.pkl", "Training_mfcc_arr.pkl", "Training_y.pkl"]}},
    version = "1.0",
